...
class OpsTestcase02LayoutManageMasterBanner(unittest.TestCase):
    def setUp(self):
    ...
    def test_ops_testcase02_layoutnmanage_masterbanner(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("ul.nav.navbar-nav li:first-child.dropdown ul.dropdown-menu li:nth-child(1) a").click()
        self.assertEqual(driver.title, u"e袋洗城市运营后台")
