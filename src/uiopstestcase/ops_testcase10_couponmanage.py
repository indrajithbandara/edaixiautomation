...
class OpsTestcase10couponmanage(unittest.TestCase):
    ...
    def test_ops_testcase10_couponmanage(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectops.ops_tab_couponmanage+") a").click()
        driver.implicitly_wait(10)
        print driver.title
        #driver.find_element_by_css_selector("div#container.container a.btn.btn-sm.btn-info").send_keys(Keys.ENTER)
 
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys(u"优惠券添加")
        #html body div#container form div.input-group span.input-group-btn input.btn.btn-info
        driver.find_element_by_css_selector("div#container form div.input-group span.input-group-btn input.btn.btn-info").click()
