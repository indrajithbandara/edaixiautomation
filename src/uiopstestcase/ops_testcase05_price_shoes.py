...
class OpsTestcase05PriceShoes(unittest.TestCase):
    def setUp(self):
        ...
        #sconf.read("C:/edaixi_testdata/userdata_ops.conf")
    ...
    def test_ops_testcase05_PriceShoes(self):
        driver = self.driver
        ...
        self.assertEqual(driver.title, u"e袋洗城市运营后台")   
        driver.find_element_by_css_selector("div#container.container ul#myTab.nav.nav-tabs li:nth-child(2) a").send_keys(Keys.ENTER)
