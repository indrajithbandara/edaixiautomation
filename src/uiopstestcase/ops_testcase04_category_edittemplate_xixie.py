...
class OpsTestcase04Categoryedittemplatexixie(unittest.TestCase):
    def setUp(self):
    ...
    def test_ops_testcase04_Categoryedittemplatexixie(self):
        driver = self.driver        
        ...
        self.assertEqual(driver.title, u"e袋洗城市运营后台")
        #driver.find_element_by_css_selector("div#container.container ul#myTab.nav.nav-tabs li:nth-child(3) a").click()
        driver.find_element_by_css_selector("div#container.container ul#myTab.nav.nav-tabs li:nth-child(2) a").click()
        ...
        driver.find_element_by_id("service_good_form_name").send_keys("xixieleimutemplate")
