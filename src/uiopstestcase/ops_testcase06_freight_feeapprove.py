...
import appobjectops
class OpsTestcase06freightfeeapprove(unittest.TestCase):
    def setUp(self):
    ...
    def test_ops_testcase06_freightfeeapprove(self):
        driver = self.driver
        ...
        if agreewithfiled != "":
            driver.find_element_by_css_selector("div#container.container table.table.table-bordered.table-striped tbody tr:nth-child(2) td:last-child a").click()
