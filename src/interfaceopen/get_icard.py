...
from interfaceopen import interfaceopen_utils

class get_icard(unittest.TestCase):
    def setUp(self):
        #self.widget = Widget('The widget')
        httpClient = None
        #self.httpClient = httplib.HTTPConnection('open09.edaixi.cn', 81, timeout=10)
        self.httpClient = httplib.HTTPConnection(interfaceopen_utils.interfaceopen_testdata_localhost, interfaceopen_utils.interfaceopen_testdata_port, timeout=10)
    ...
    def test_get_icard(self):
        try:
            
            f=open(interfaceopen_utils.interfaceopen_testdata_path+"open_create_order.json")
