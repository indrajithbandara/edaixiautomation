...
class wechatTestcase03twodimensioncodecreateqrcode(unittest.TestCase):
    def setUp(self):
    ...
    def test_wechat_testcase03_twodimensioncode_createqrcode(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_createqrcode+")>a").click()
