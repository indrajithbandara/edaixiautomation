...
class WechatTestcase02mainbusinesswechatcouple(unittest.TestCase):
    def setUp(self):
    ...
    def test_wechat_testcase02_mainbusiness_wechatcouple(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_mainbusiness_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_mainbusiness_wechatcouple+")>a").click()
