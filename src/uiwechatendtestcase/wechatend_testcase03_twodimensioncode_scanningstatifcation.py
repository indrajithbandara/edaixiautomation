...
class wechatTestcase03twodimensioncodescanningstatifcation(unittest.TestCase):
    def setUp(self):
    ...
    def test_wechat_testcase03_twodimensioncode_scanningstatifcation(self):
        driver = self.driver
        ...
        #html body div.content-main table#frametable tbody tr td.content-left.mCustomScrollbar._mCS_11 div#mCSB_11.mCustomScrollBox.mCS-dark-thin div.mCSB_container div.sidebar-nav div#snav ul:first-child.snav li:nth-child(1).snav-header.open a
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode+")>a").click()
        #driver.find_element_by_link_text(u"基本设置").click()
        #driver.find_element_by_css_selector(appobjectops.clickPermissionLink).click()
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_scanningstatifcation+")>a").click()
