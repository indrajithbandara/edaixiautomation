...
class wechatTestcase03twodimensioncodexiaoeqrcode(unittest.TestCase):
    def setUp(self):
    ...
    def test_testcase03_twodimensioncode_xiaoeqrcode(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_xiaoeqrcode+")>a").click()
