...
class HongbaoTestcase06hongbaorecommendhongbao(unittest.TestCase):
    def setUp(self):
    ...
    def test_hongbao_testcase06_hongbao_recommendhongbao(self):
        driver = self.driver
...
#         ActionChains(driver).double_click(loginclick).perform()
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_hongbao_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_hongbao_recommendhongbao+")>a").click()
