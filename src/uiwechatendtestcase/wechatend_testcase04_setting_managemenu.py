...
#Credit
class WechatTestcase04settingmanagemenu(unittest.TestCase):
    def setUp(self):
    ...
    def test_wechat_testcase04_setting_managemenu(self):
        driver = self.driver
...
#         ActionChains(driver).double_click(loginclick).perform()
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_setting_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_setting_managemenu+")>a").click()
