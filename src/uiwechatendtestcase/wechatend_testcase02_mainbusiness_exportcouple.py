...
class WechatTestcase02mainbusinessexportcouple(unittest.TestCase):
    def setUp(self):
    ...
    def test_ops_testcase02_mainbusiness_exportcouple(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_mainbusiness_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_mainbusiness_exportcouple+")>a").click()
        ...
        driver.execute_script("$('div[class=content-main]').show();") 
        
        driver.switch_to_frame("main") 
        time.sleep(1)#content-main
        
        driver.find_element_by_name("submit").click()
        
        #driver.find_element_by_css_selector("span3").click()
