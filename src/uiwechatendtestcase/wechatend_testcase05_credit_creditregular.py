...
class CreditTestcase05creditcreditregular(unittest.TestCase):
    def setUp(self):
    ...
    def test_credit_testcase05_credit_creditregular(self):
        driver = self.driver
...
#         ActionChains(driver).double_click(loginclick).perform()
        ...
        #html body div.content-main table#frametable tbody tr td.content-left.mCustomScrollbar._mCS_11 div#mCSB_11.mCustomScrollBox.mCS-dark-thin div.mCSB_container div.sidebar-nav div#snav ul:first-child.snav li:nth-child(1).snav-header.open a
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_credit_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_credit+")>a").click()
        #driver.find_element_by_link_text(u"基本设置").click()
        #driver.find_element_by_css_selector(appobjectops.clickPermissionLink).click()
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_credit_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_credit_creditregular+")>a").click()
