...
class WechatTestcase03twodimensioncodebatchcreate(unittest.TestCase):
    def setUp(self):
    ...
    def test_twodimensioncode_testcase03_twodimensioncode_batchcreate(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_twodimensioncode_batchcreate+")>a").click()
