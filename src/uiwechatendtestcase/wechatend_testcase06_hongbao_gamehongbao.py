...
#         ActionChains(driver).double_click(loginclick).perform()
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_hongbao_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_hongbao_gamehongbao+")>a").click()
