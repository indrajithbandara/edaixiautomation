...
class PromotionTestcase07promotionwebpushorderlink(unittest.TestCase):
    def setUp(self):
    ...
    def test_promotion_testcase07_promotion_webpushorderlink(self):
        driver = self.driver
...
#         ActionChains(driver).double_click(loginclick).perform()
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div.mCSB_container>div.sidebar-nav>div#snav>ul:nth-child("+appobjectwechat.wechatend_tab_promotion_ul+")>li:nth-child("+appobjectwechat.wechatend_tab_promotion_webpushorderlist+")>a").click()
