...
class KefuTestcase00rdt3orderlist(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase00_rdt3_orderlist(self):
        driver = self.driver
...
#         self.assertEqual(u"确认发券吗？", self.close_alert_and_get_its_text())
        ...
        driver.find_element_by_id("order_search_form_ordersn").send_keys(kefu_utiltools.ordersnnumer)
        ...
        driver.find_element_by_id("order_search_form_username").send_keys(kefu_utiltools.username)
        driver.find_element_by_name("commit").click()
        time.sleep(2)
        self.assertEqual(driver.title,u"客服系统")
        driver.find_element_by_id("order_search_form_username").clear()
        driver.find_element_by_id("order_search_form_address").clear()
        driver.find_element_by_id("order_search_form_address").send_keys(kefu_utiltools.address)
        driver.find_element_by_name("commit").click()
        time.sleep(2)
        self.assertEqual(driver.title,u"客服系统")
        driver.find_element_by_id("order_search_form_address").clear()
        driver.find_element_by_id("order_search_form_tel").clear()
        driver.find_element_by_id("order_search_form_tel").send_keys(kefu_utiltools.telephonenumber)
        driver.find_element_by_name("commit").click()
        time.sleep(2)
