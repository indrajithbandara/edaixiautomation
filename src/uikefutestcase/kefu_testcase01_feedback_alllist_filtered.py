...
class KefuTestcase01FeedbackAlllistFiltered(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase01_feedback_alllist_filtered(self):
        driver = self.driver
        ...
        self.assertEqual(driver.title,u"客服系统")
        driver.find_element_by_css_selector("a.btn.btn-success.btn-sm").click()
