...
class KefuTestcase02MyUserFeedbackAlllistNeedfeedback(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase02_myuserfeedback_alllist_needfeedback(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectkefu.kefu_tab_myuserfeedback+")>a").click()
