...
import appobjectkefu,MySQLdb,kefu_utiltools
class KefuTestcase00rdt2orderlist(unittest.TestCase):
    ...
    def test_kefu_testcase00_rdt2_orderlist(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectkefu.kefu_tab_test00_orderlist+")>a").click()
