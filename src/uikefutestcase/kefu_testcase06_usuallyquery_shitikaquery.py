...
class KefuTestcase06UsuallyqueryShitikaquery(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase06_usuallyquery_shitikaquery(self):
        driver = self.driver
        ...
        self.assertEqual(driver.title,u"客服系统")
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectkefu.kefu_tab_usuallyquery+").dropdown>ul.dropdown-menu>li:nth-child(2)>a").click()
