...
class KefuTestcase05UsuallyreplySearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase05_usuallyreply_search(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.col-md-5 > form > div.input-group > #content").send_keys(u"您好")
