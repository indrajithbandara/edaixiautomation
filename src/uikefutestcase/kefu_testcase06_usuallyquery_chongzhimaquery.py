...
class KefuTestcase06UsuallyqueryChongzhimaquery(unittest.TestCase):
    ...
    def test_kefu_testcase06_usuallyquery_chongzhimaquery(self):
        ...
        self.assertEqual(driver.title,u"客服系统")
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child(7).dropdown>ul.dropdown-menu>li:nth-child(5)>a").click()
