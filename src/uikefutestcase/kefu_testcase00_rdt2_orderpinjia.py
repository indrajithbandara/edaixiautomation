...
class KefuTestcase00rdt2orderpinjia(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_testcase00_rdt2_orderpinjia(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectkefu.kefu_tab_test00_orderpinjia+")>a").click()
        time.sleep(1)
        #driver.find_element_by_link_text(u"踢").click()
        driver.find_element_by_link_text(u"全五星").click()
        time.sleep(1)
        self.assertEqual(driver.title,u"客服系统")
...
#         driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child(6)>a").click()
        ...
        driver.find_element_by_link_text(u"四星").click()
        time.sleep(1)
        self.assertEqual(driver.title,u"客服系统")
#         driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child(6)>a").click()

        driver.find_element_by_link_text(u"三星及以下").click()
