...
class WuliuTestcase04pushorder(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase04_pushorder(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container nav.collapse.navbar-collapse.bs-navbar-collapse ul.nav.navbar-nav li:nth-child("+appobjectwuliu.wuliutabfive+") a").click()
        #self.assertTrue(driver.title, u"物流")
        self.assertEqual(driver.title, u"物流")
