...
class WuliuTestcase08CitylistselfmanagedLogistics(unittest.TestCase):
    ...
    def test_wuliu_testcase08_citylist_selfmanagedLogistics(self):
        ...
        driver.find_element_by_css_selector("div#container.container div.panel.panel-primary.checkout-order table.table.table-striped.city-table tbody tr:nth-child(2) td:nth-child(2).btn-link a:nth-child("+str(5)+")").click()
...
#         telephonenumberedit=random.choice(['132','188','135','131','159','188'])+"".join(random.choice("0123456789") for i in range(8))
#         print " the telephonenumberedit is ",telephonenumberedit
#         identifiedCardIdedit=wuliu_utiltools.makeNewOtherIdentifiedCardId()
#         print " the identifiedCardIdedit is ",identifiedCardIdedit
#         driver.find_element_by_id("courier_form_id_number").clear()
#         driver.find_element_by_id("courier_form_id_number").send_keys(identifiedCardIdedit)
#         driver.find_element_by_id("courier_form_password").clear()
#         driver.find_element_by_id("courier_form_tel").clear()
