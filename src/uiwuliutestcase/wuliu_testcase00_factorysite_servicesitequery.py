...
class WuliuTestcase00siteservicesitequery(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase00_site_servicesitequery(self):
        driver = self.driver
        ...
        print " the test case  WuliuTestcase00siteservicesitequery  is ",driver.title
