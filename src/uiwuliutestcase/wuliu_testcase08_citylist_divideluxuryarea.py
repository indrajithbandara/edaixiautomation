...
class WuliuTestcase08Citylistdivideluxuryarea(unittest.TestCase):
    ...
    def test_wuliu_testcase08_citylist_divideluxuryarea(self):
        ...
        time.sleep(2)
        print "the testcase test_wuliu_testcase08_citylist_divideluxuryarea is ",driver.title
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div#container.container div.panel.panel-primary.checkout-order table.table.table-striped.city-table tbody tr:nth-child(2) td:nth-last-child(2).btn-link a:nth-child(4)").click()
        self.assertEqual(driver.title, u"物流")
        time.sleep(2)
