...
class WuliuTestcase08citylistdiaodupaidanfanxidanYiConfirm(unittest.TestCase):
    ...
    def test_wuliu_testcase08citylist_diaodupaidan_fanxidan_yiconfirm(self):
        driver = self.driver
...
#         driver.find_element_by_xpath("//input[@type='submit']").click()
        ...
        driver.find_element_by_id("fanxi_order_form_washing_date").send_keys(str(wuliu_utiltools.get_day_of_day(3)))
