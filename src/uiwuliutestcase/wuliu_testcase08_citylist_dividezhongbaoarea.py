...
class WuliuTestcase08Citylistdividezhongbaoarea(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase08_citylist_dividezhongbaoarea(self):
        driver = self.driver
        ...
        time.sleep(2)
        print "the testcase test_wuliu_testcase08_citylist_dividezhongbaoarea is ",driver.title
        ...
        time.sleep(1)
        driver.find_element_by_css_selector("div#container.container div.panel.panel-primary.checkout-order table.table.table-striped.city-table tbody tr:nth-child(2) td:nth-last-child(2).btn-link a:nth-child(5)").click()
        self.assertEqual(driver.title, u"物流")
        time.sleep(2)
        driver.find_element_by_id("address_input").clear()
        driver.find_element_by_id("address_input").send_keys(u"朝阳区酒仙桥七九八")
