...
class WuliuTestcase07AccountBalance(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase07_accountbalance(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container nav.collapse.navbar-collapse.bs-navbar-collapse ul.nav.navbar-nav li:nth-child("+appobjectwuliu.wuliutabeight+") a").click()
        self.assertEqual(driver.title, u"物流")
