...
class WuliuTestcase00sitepeoplemanage(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase00_site_peoplemanage(self):
        driver = self.driver
        ...
        print " the testcase WuliuTestcase00sitepeoplemanage is ",driver.title
        self.assertEqual(driver.title, u"物流")
        time.sleep(2)
        
        driver.find_element_by_css_selector("div.container>nav.collapse.navbar-collapse.bs-navbar-collapse>ul.nav.navbar-nav>li:nth-child(3)>a").click()
