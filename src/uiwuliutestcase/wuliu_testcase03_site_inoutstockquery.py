...
class WuliuTestcase03siteinoutstockquery(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuliu_testcase03_site_inoutstockquery(self):
        driver = self.driver
...
#         print driver.title
#         self.assertEqual(driver.title, u"物流")
        #html body div#container.container div.panel.panel-primary div.panle-body form#wangdian_form table tbody tr td:nth-child(2) select#in_out_type.form-control.single_input option:nth-child(1)
