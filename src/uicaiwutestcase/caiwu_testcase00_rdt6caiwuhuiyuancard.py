...
class CaiwuTestcase00rdt6caiwuhuiyuancard(unittest.TestCase):
    ...
    def test_caiwu_testcase00_rdt6caiwuhuiyuancard(self):
        ...
        driver.find_element_by_css_selector("div.container>div.navbar-collapse.collapse.navbar-responsive-collapse>ul.nav.navbar-nav>li:nth-child("+appobjectcaiwu.caiwu_tab_rdt6_huiyuancard+")>a").click()
        ...
        driver.find_element_by_css_selector("ul.nav.navbar-nav>li:nth-child("+appobjectcaiwu.caiwu_tab_rdt6_huiyuancard+").dropdown>ul.dropdown-menu>li:first-child>a").click()
        self.assertEqual(driver.title,u"财务")
