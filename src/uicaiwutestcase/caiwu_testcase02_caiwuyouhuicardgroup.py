...
class CaiwuTestcase02Caiwuyouhuicardgroup(unittest.TestCase):
    ...
    def test_caiwu_testcase02_caiwuyouhuicardgroup(self):
        ...
        self.assertEqual(driver.title,u"财务")
        driver.find_element_by_css_selector("ul.nav.navbar-nav li:nth-child("+appobjectcaiwu.caiwu_tab_caiwuyouhuicardlist+").dropdown ul.dropdown-menu li:last-child a").click()
        self.assertEqual(driver.title,u"财务")
