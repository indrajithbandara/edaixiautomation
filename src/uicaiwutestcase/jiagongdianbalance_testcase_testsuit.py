...
from caiwu_testcase08_citylist_jiagongdian_factorbalancebranch import *
from caiwu_testcase08_citylist_jiagongdian_factorbalancemaster import *
from uiwuliutestcase.wuliu_testcase08_citylist_jiagongdian_factorbalance import *

if __name__ == '__main__':  
    suite = unittest.TestSuite()  
    print "This is jiagongdian balance business logic testcases..."
...
#     time.sleep(2)
    ...
    fp = file("c:\\edaixi_testdata\\"+currenttime+"-business_test_report.html", 'wb')
    
    htmlRunner= HTMLTestRunner.HTMLTestRunner(stream=fp,title="edaixi business testing result",description="201508 luke")
