...
class CaiwuTestcase00rdt5caiwuchongzhicard(unittest.TestCase):
    def setUp(self):
    ...
    def test_caiwu_testcase00_rdt5caiwuchongzhicard(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child("+appobjectcaiwu.caiwu_tab_rdt5_chongzhi+").dropdown a.dropdown-toggle").click()
        ...
        driver.find_element_by_css_selector("ul.nav.navbar-nav>li:nth-child("+appobjectcaiwu.caiwu_tab_rdt5_chongzhi+").dropdown>ul.dropdown-menu>li:first-child>a").click()
        self.assertEqual(driver.title,u"财务")
        ...
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child(4).dropdown a.dropdown-toggle").click()
        #driver.find_element_by_link_text(u"优惠券组").click()
        self.assertEqual(driver.title,u"财务")
        #html body div.navbar.navbar-default.navbar-static-top div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child(2).dropdown ul.dropdown-menu li:first-child a
        driver.find_element_by_css_selector("ul.nav.navbar-nav>li:nth-child(4).dropdown>ul.dropdown-menu>li:nth-child(2)>a").click()
...
#         card_id
        ...
        driver.find_element_by_id("sncode").send_keys("chongzhicardnameedit")
        driver.find_element_by_name("commit").click()
        time.sleep(1)
        self.assertEqual(driver.title,u"财务")
        driver.find_element_by_id("card_id").clear()
        driver.find_element_by_id("card_id").send_keys("chongzhicardnameedit")
        driver.find_element_by_name("commit").click()
        self.assertEqual(driver.title,u"财务")
