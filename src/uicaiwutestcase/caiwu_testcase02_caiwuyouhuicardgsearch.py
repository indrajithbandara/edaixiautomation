...
class CaiwuTestcase02Caiwuyouhuicardgsearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_caiwu_testcase02_caiwuyouhuicardsearch(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("ul.nav.navbar-nav li:nth-child("+appobjectcaiwu.caiwu_tab_caiwuyouhuicardlist+").dropdown ul.dropdown-menu li:nth-child(2) a").click()
        time.sleep(1)
