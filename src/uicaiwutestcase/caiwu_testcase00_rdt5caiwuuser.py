...
class CaiwuTestcase00rdt5caiwuuser(unittest.TestCase):
    ...
    def test_caiwu_testcase00_rdt5caiwuuser(self):
        ...
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child("+appobjectcaiwu.caiwu_tab_rdt5_user+").dropdown a.dropdown-toggle").click()
        ...
        driver.find_element_by_css_selector("ul.nav.navbar-nav>li:nth-child("+appobjectcaiwu.caiwu_tab_rdt5_user+").dropdown>ul.dropdown-menu>li:nth-child(1)>a").click()
